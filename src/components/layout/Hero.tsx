...
const Hero = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // 3D Card Tilt Effect (Mouse Move)
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-left">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button variant="ghost" className="hero-cta text-slate-600 hover:text-blue-600 flex items-center gap-2">
                <PlayCircle className="w-5 h-5" /> View Case Studies
              </Button>
            </div>
          </div>

          {/* Right Content - 3D Animated Card */}
          <div className="flex-1 perspective-1000 w-full max-w-2xl">
            ...
            >
              <div className="aspect-square rounded-[2rem] overflow-hidden bg-slate-900 relative">
                {/* Lottie Animation Placeholder - Replace 'animationData' with your exported JSON */}
                <Lottie 
                  animationData={null} // User to provide Lottie JSON
                  path="https://assets9.lottiefiles.com/packages/lf20_qp1q7mct.json" // High-quality fallback
                  loop={false}
