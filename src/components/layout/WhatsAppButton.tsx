    ...
    <AnimatePresence>
      {isVisible && (
        <motion.a
          ...
          whileTap={{ scale: 0.9 }}
          className="fixed bottom-28 left-4 sm:left-6 z-[100] flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-[#25D366] text-white rounded-full shadow-2xl hover:bg-[#20ba5a] transition-colors"
