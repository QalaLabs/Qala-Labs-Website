      ...
      <div className="pt-32 pb-20 px-4 max-w-4xl mx-auto">
        ...
        <div className="prose prose-slate max-w-none space-y-8">
          <section>
            ...
            <p className="text-black">Qala Labs ("Company," "we," "us," or "our") operates the website and related services. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services. Please read this privacy policy carefully. If you do not agree with our policies and practices, please do not use our services.</p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-black">We collect information you voluntarily provide to us, including:</p>
              ...
              <div>
                ...
                <p className="text-black">When you access our website, we automatically collect certain information:</p>
                <ul className="list-disc pl-6 mt-2 space-y-2">
              ...
              <div>
                ...
                <p className="text-black">We use cookies, web beacons, pixels, and similar tracking technologies to:</p>
                <ul className="list-disc pl-6 mt-2 space-y-2">
          ...
          <section>
            ...
            <p className="text-black">Our website uses Meta Pixel (formerly Facebook Pixel) to track user interactions and measure conversion events. The Meta Pixel allows us to:</p>
          ...
          <section>
            ...
            <p className="text-black">We may share your information with:</p>
            <ul className="list-disc pl-6 mt-3 space-y-2">
          ...
          <section>
            ...
            <p className="text-black">We retain your information for as long as necessary to provide our services and fulfill the purposes outlined in this policy. Retention periods vary depending on the type of information and the context of processing:</p>
            <ul className="list-disc pl-6 mt-3 space-y-2">
          ...
          <section>
            ...
            <p className="text-black">Depending on your location, you may have the following rights:</p>
          ...
          <section>
            ...
            <p className="text-black">We implement industry-standard security measures to protect your information from loss, theft, misuse, and unauthorized access, disclosure, alteration, and destruction. These include:</p>
            <ul className="list-disc pl-6 mt-3 space-y-2">
          ...
          <section>
            ...
            <p className="text-black">If you are located outside the United States, your information may be transferred to, stored in, and processed in the United States or other countries. By using our services, you consent to such transfers. We implement appropriate safeguards for international data transfers, including Standard Contractual Clauses and Privacy Shield mechanisms where applicable.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4">9. Children's Privacy</h2>
            <p className="text-black">Our services are not directed to children under 13. We do not knowingly collect personal information from children under 13. If we become aware that a child under 13 has provided us with personal information, we will delete such information and terminate the child's account. If you believe a child has provided us with personal information, please contact us immediately.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4">10. Third-Party Links</h2>
            <p className="text-black">Our website may contain links to third-party websites. We are not responsible for the privacy practices of these external sites. We encourage you to review the privacy policies of any third-party website before providing your information or engaging with their services.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4">11. Marketing Communications</h2>
            <p className="text-black">We may send you promotional emails, newsletters, and marketing communications. You can opt out of these communications at any time by:</p>
            <ul className="list-disc pl-6 mt-3 space-y-2">
          ...
          <section>
            ...
            <p className="text-black">For California residents, we provide the following additional disclosures:</p>
            <ul className="list-disc pl-6 mt-3 space-y-2">
          ...
          <section>
            ...
            <p className="text-black">We may update this privacy policy periodically to reflect changes in our practices, technology, legal requirements, or other factors. We will notify you of material changes by updating the "Last updated" date above and, where required by law, obtaining your consent. Your continued use of our services following notification of changes constitutes your acceptance of the updated privacy policy.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4">14. Contact Us</h2>
            <p className="text-black">If you have questions, concerns, or requests regarding this privacy policy or our privacy practices, please contact us:</p>
            <div className="bg-slate-50 p-6 rounded-lg mt-4 space-y-2">
              ...
              <p className="text-black"><strong>Address:</strong> Qala Labs, [Your Company Address]</p>
            </div>
          ...
          <section>
            ...
            <p className="text-black">If you are in the EU or similar jurisdiction, you may have the right to contact our Data Protection Officer:</p>
