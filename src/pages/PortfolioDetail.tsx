    ...
    blocks: [
      {
        ...
        content: `We architected Capital Keys' full-stack digital ecosystem: a sleek, conversion-optimized platform dominating the premium real estate scene. Think jaw-dropping listings, real-time lead intelligence, and admin dashboards that turn data into deals.
            ...
            <div className="relative p-12 md:p-20 bg-slate-900 rounded-[3.5rem] overflow-hidden text-center shadow-2xl">
              <div className="relative z-10">
                <h2 className="text-3xl md:text-5xl font-black mb-10 leading-tight text-white">
                  {data.websiteUrl ? "Ready to dominate your vertical?" : "Let's build your scale engine."}
                </h2>
