...
const aiCapabilities: Capability[] = [
  ...
  {
    id: 'proptech-crm',
    title: 'Proptech Platform & CRM',
    subtitle: 'High-conversion inquiry architecture & sales automation',
    desc: '64.7% inquiry-to-lead conversion with sub-90s webhook response latency for property buyers.',
    badge1: '64.7% Conversion',
    badge2: '17+ Qualified Leads',
